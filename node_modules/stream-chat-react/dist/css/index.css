...
@media screen and (max-width: 960px) {
  .str-chat-channel-list-burger {
    display: flex; }
  .str-chat-channel-list.messaging, .str-chat-channel-list.team {
    position: fixed;
    left: -300px;
    top: 0;
    z-index: 1001;
  ...
  .str-chat-channel-checkbox:checked ~ .str-chat-channel-list.messaging, .str-chat-channel-checkbox:checked ~ .str-chat-channel-list.team {
    left: 0px; } }
...
.str-chat__input {
  ...
  .str-chat__input-emojiselect, .str-chat__input-fileupload {
    ...
    fill: rgba(0, 0, 0, 0.6); }
    .str-chat__input-emojiselect:hover, .str-chat__input-fileupload:hover {
      fill: black; }
...
.livestream.str-chat .str-chat__input {
  padding: 10px 40px; }
  .team.str-chat .str-chat__input-emojiselect, .team.str-chat .str-chat__input-fileupload,
  .livestream.str-chat .str-chat__input-emojiselect,
  .livestream.str-chat .str-chat__input-fileupload {
    top: calc(100% - 44px); }
  .team.str-chat .str-chat__input-emojiselect,
  .livestream.str-chat .str-chat__input-emojiselect {
    right: 50px; }
  .team.str-chat .str-chat__input-fileupload,
  .livestream.str-chat .str-chat__input-fileupload {
    right: 76px; }
...
.livestream.str-chat .str-chat__input {
  ...
  .livestream.str-chat .str-chat__input textarea {
    ...
    font-size: 13px;
    padding: 12px; }
  .livestream.str-chat .str-chat__input-emojiselect, .livestream.str-chat .str-chat__input-fileupload {
    top: calc(100% - 40px); }
  .livestream.str-chat .str-chat__input-emojiselect {
    right: 30px; }
  .livestream.str-chat .str-chat__input-fileupload {
...
.str-chat__message-reactions-list-item {
  ...
  .str-chat__message-reactions-list-item .latest-user {
    ...
    top: -24px;
    left: 0; }
    .str-chat__message-reactions-list-item .latest-user .str-chat__avarar {
      margin: 0; }
...
.str-chat__small-message-input {
  ...
  .str-chat__small-message-input-emojiselect, .str-chat__small-message-input-fileupload {
    ...
    background-size: 44px 44px;
    fill: rgba(0, 0, 0, 0.6); }
    .str-chat__small-message-input-emojiselect:hover, .str-chat__small-message-input-fileupload:hover {
      fill: black; }
...
.team.str-chat.dark .str-chat__thread {
  ...
  .team.str-chat.dark .str-chat__thread-header {
    background: rgba(255, 255, 255, 0.03);
    box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.34);
    color: white; }
  .livestream.str-chat.dark .str-chat__thread-start,
  .team.str-chat.dark .str-chat__thread-start {
    background: rgba(153, 196, 255, 0.1);
    border-radius: 4px;
    color: white; }
