...
function (_PureComponent) {
  ...
  function Attachment() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "attachmentRef", React__default.createRef());
...
function (_React$Component) {
  ...
  function MessageActionsBox() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "actionsBoxRef", React__default.createRef());
  ...
  _createClass(MessageActionsBox, [{
    ...
    value: function render() {
      ...
      }, Message.isMyMessage && !Message.isMyMessage(message) && React__default.createElement("button", {
        onClick: Message.handleFlag
      }, React__default.createElement("li", {
        className: "str-chat__message-actions-list-item"
      }, "Flag")), Message.isMyMessage && !Message.isMyMessage(message) && React__default.createElement("button", {
        onClick: Message.handleMute
      }, React__default.createElement("li", {
        className: "str-chat__message-actions-list-item"
      }, "Mute")), Message.canEditMessage && Message.canEditMessage(message) && React__default.createElement("button", {
        onClick: Message.handleEdit
      }, React__default.createElement("li", {
        className: "str-chat__message-actions-list-item"
      }, "Edit Message")), Message.canDeleteMessage && Message.canDeleteMessage(message) && React__default.createElement("button", {
...
function (_React$Component) {
  ...
  function ReactionsList(props) {
    ...
    _this.reactionList = React__default.createRef();
    return _this;
  }
...
function (_React$PureComponent) {
  ...
  function LoadingIndicator() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "stopRef", React__default.createRef());
  ...
  function ReactionSelector(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderReactionItems", function () {
      ...
      var lis = _this.props.reactionOptions.map(function (reaction) {
        ...
        return React__default.createElement("li", {
        ...
        }, count && _this.props.detailedView && React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
          ...
          data: emojiData
        })), count && _this.props.detailedView && React__default.createElement("span", {
...
function (_React$PureComponent) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "innerRef", React__default.createRef());
  ...
  _createClass(UserItem, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        size: 20,
        image: u.image
      }), React__default.createElement("div", null, React__default.createElement("strong", null, u.name), " ", u.id));
    }
  }]);
...
function (_PureComponent) {
  ...
  _createClass(MessageInputLarge, [{
    ...
    value: function render() {
      ...
      }, this.props.watcher_count && React__default.createElement("span", null, this.props.watcher_count, " online"), React__default.createElement("span", {
...
function (_PureComponent) {
  ...
  function MessageSimple() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "messageActionsRef", React__default.createRef());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "reactionSelectorRef", React__default.createRef());
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderStatus", function () {
      ...
      if (_this.props.message.status === 'sending') {
        ...
        return React__default.createElement("span", {
          className: "str-chat__message-simple-status"
        }, React__default.createElement(Tooltip, null, _this.formatArray(message.readBy)), React__default.createElement(Avatar, {
          name: _this.props.readBy[0].id,
          image: _this.props.readBy[0].image,
          size: 15
        }), message.readBy.length > 1 && React__default.createElement("span", {
  ...
  _createClass(MessageSimple, [{
    ...
    value: function renderOptions() {
      ...
      if (this.isMine()) {
        return React__default.createElement("div", {
          ...
          fillRule: "nonzero"
        }))), !this.props.threadList && React__default.createElement("div", {
        ...
        return React__default.createElement("div", {
          ...
          d: "M8.516 3c4.78 0 4.972 6.5 4.972 6.5-1.6-2.906-2.847-3.184-4.972-3.184v2.872L3.772 4.994 8.516.5V3zM.484 5l4.5-4.237v1.78L2.416 5l2.568 2.125v1.828L.484 5z",
          fillRule: "evenodd"
        }))), (Message.canEditMessage(message) || Message.canDeleteMessage(message)) && React__default.createElement("div", {
          onClick: this._onClickOptionsAction,
          className: "str-chat__message-simple__actions__action str-chat__message-simple__actions__action--options"
        }, React__default.createElement(MessageActionsBox, {
          Message: Message,
    ...
    value: function render() {
      ...
      if (message.deleted_at) {
        ...
        }, message.user.id === this.props.client.user.id ? 'You' : message.user.name || message.user.id, ' ', "deleted this message..."), !this.props.threadList && message.reply_count !== 0 && React__default.createElement("div", {
      ...
      return React__default.createElement(React__default.Fragment, null, this.props.editing && React__default.createElement(Modal, {
      ...
      })), React__default.createElement("div", null, hasAttachment && images.length <= 1 && message.attachments.map(function (attachment, index) {
        ...
        className: "str-chat__simple-message--error-message"
      }, "Message Failed \xB7 Click to try again"), renderText(message.text), hasReactions > 0 && !this.state.showDetailedReactions && React__default.createElement(ReactionsList, {
        mine: this.isMine(),
        messageList: this.props.messageListRect,
        position: this.isMine() ? 'right' : 'left',
        reactions: message.latest_reactions,
        ...
        messageList: this.props.messageListRect,
        ref: this.reactionSelectorRef
      })), message.text && this.renderOptions()), !this.props.threadList && message.reply_count !== 0 && React__default.createElement("div", {
        className: "str-chat__message-simple-reply-button"
      }, React__default.createElement(MessageRepliesCountButton, {
        onClick: this.props.openThread,
        reply_count: message.reply_count
...
function (_PureComponent2) {
      ...
      _regeneratorRuntime.mark(function _callee3(_ref3) {
        ...
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                text = _ref3.text, _ref3$attachments = _ref3.attachments, attachments = _ref3$attachments === void 0 ? [] : _ref3$attachments, parent = _ref3.parent;
  ...
  _createClass(ChannelInner, [{
    ...
    value: function render() {
      ...
      if (this.state.error) {
        core = React__default.createElement("div", null, "Error: ", this.state.error.message);
...
function (_PureComponent) {
  ...
  function ChannelPreviewLastMessage() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "channelPreviewButton", React__default.createRef());
...
function (_PureComponent) {
  ...
  _createClass(ChannelList, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement(List, _extends({}, this.props, this.state, context))));
    }
  }], [{
...
function (_PureComponent) {
  ...
  _createClass(ChannelPreviewMessenger, [{
    ...
    value: function render() {
      ...
      }, channel.data.name), React__default.createElement("div", {
    ...
    value: function render() {
      ...
      if (message.deleted_at) {
        return React__default.createElement(React__default.Fragment, null, React__default.createElement("span", {
          key: message.id,
          className: "".concat(messageClasses, " str-chat__message--deleted ").concat(message.type, " ")
        }, message.user.id === this.props.client.user.id ? 'You' : message.user.name || message.user.id, ' ', "deleted this message..."), React__default.createElement("div", {
          className: "clearfix"
        }));
      }
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
      ...
      }, "Error \xB7 Unsent"), renderText(message.text), hasReactions > 0 && !this.state.showDetailedReactions && React__default.createElement(ReactionsList, {
        mine: !this.isMine(),
        messageList: this.props.messageListRect,
        reactions: message.latest_reactions,
        reaction_counts: message.reaction_counts,
        ...
        messageList: this.props.messageListRect,
        ref: this.reactionSelectorRef
      })), message.text && this.renderOptions()), !this.props.threadList && React__default.createElement("div", {
...
function (_React$PureComponent) {
  ...
  function MessageLivestream() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "editMessageFormRef", React__default.createRef());
  ...
  _createClass(MessageLivestream, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        ...
        messageList: this.props.messageListRect,
        ref: this.reactionSelectorRef
      }), !this.props.initialMessage && message.type !== 'error' && React__default.createElement("div", {
        className: "str-chat__message-livestream-actions"
      }, React__default.createElement("span", {
        className: "str-chat__message-livestream-time"
      }, moment(message.created_at).format('h:mmA')), React__default.createElement("span", {
        onClick: this.onClickReactionsAction
      }, React__default.createElement("span", {
        dangerouslySetInnerHTML: {
          __html: reactionSvg
        }
      })), !this.props.threadList && React__default.createElement("span", {
        dangerouslySetInnerHTML: {
          __html: threadSvg
        },
        onClick: function onClick(e) {
      ...
      }, message.type !== 'error' && message.status !== 'failed' && renderText(message.text), message.type === 'error' && !message.command && React__default.createElement("p", null, React__default.createElement("svg", {
        width: "14",
        height: "14",
        xmlns: "http://www.w3.org/2000/svg"
      }, React__default.createElement("path", {
        ...
        handleReaction: this.props.handleReaction
      }), !this.props.initialMessage && React__default.createElement(MessageRepliesCountButton, {
        onClick: this.props.openThread,
        reply_count: message.reply_count
      })))));
    }
  ...
  _createClass(MessageTeam, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        ...
        className: "str-chat__message-team-meta"
      }, groupStyles[0] === 'top' || groupStyles[0] === 'single' || this.props.initialMessage ? React__default.createElement(Avatar, {
        image: message.user.image,
        name: message.user.name || message.user.id,
        size: 40
      }) : React__default.createElement("div", {
      ...
      }, (groupStyles[0] === 'top' || groupStyles[0] === 'single' || this.props.initialMessage) && React__default.createElement("div", {
      ...
      }, !this.props.initialMessage && message.status !== 'sending' && message.status !== 'failed' && message.type !== 'error' && React__default.createElement("div", {
      ...
      }, renderText(message.text)), galleryImages.length !== 0 && React__default.createElement(Gallery, {
        images: galleryImages
        ...
        handleReaction: this.props.handleReaction,
        reactions: message.latest_reactions
      }), !this.props.threadList && React__default.createElement(MessageRepliesCountButton, {
        onClick: this.props.openThread,
        reply_count: message.reply_count
      }))));
    }
